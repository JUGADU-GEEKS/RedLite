...
EMERGENCY_OVERRIDE_DURATION = int(os.getenv("EMERGENCY_OVERRIDE_DURATION", "25"))  # seconds
EMERGENCY_HEARTBEAT_TIMEOUT = int(os.getenv("EMERGENCY_HEARTBEAT_TIMEOUT", "10"))  # seconds
EMERGENCY_CLEAR_DISTANCE = int(os.getenv("EMERGENCY_CLEAR_DISTANCE", "45"))  # meters
