                            ...
                            <div className={`${darkMode ? 'bg-orange-900/18' : 'bg-orange-50/30'} py-3 space-y-1 rounded-b-2xl backdrop-blur-xl border-t ${darkMode ? 'border-orange-700/10' : 'border-orange-200/30'}`}>
                                {navItems.map((item, index) => (
                                    <motion.a
                                        ...
                                        className={`block px-4 py-2.5 rounded-lg text-center text-sm sm:text-base ${item.to && location.pathname === item.to ? (darkMode ? 'bg-orange-600 text-white' : 'bg-orange-400 text-white') : (darkMode ? 'text-gray-300 hover:text-white hover:bg-orange-500/8' : 'text-gray-600 hover:text-gray-900 hover:bg-orange-50/60')
